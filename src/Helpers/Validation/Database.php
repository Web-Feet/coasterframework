<?php namespace CoasterCms\Helpers\Validation;
	...
	public static function generateJson($migrationsFolder = null)
	{
		...
		foreach (scandir($migrationsFolder) as $file) {
            ...
            $migration = str_replace(
                ...
                '
                use Illuminate\Database\Migrations\Migration;
                use CoasterCms\Helpers\Validation\Database\Blueprint;
                use CoasterCms\Helpers\Validation\Database\Schema;
                use CoasterCms\Helpers\Validation\Database\DB;',
                $migration
            );
