<div id="installTheme" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary no-page-data" data-dismiss="modal" data-option="0"><i class="fa fa-file-o"></i> &nbsp; Install theme</button>
            </div>
        </div>
    </div>
</div>
