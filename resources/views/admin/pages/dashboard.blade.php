...
<div class="row">
  <div class="col-md-8">
    @if ($any_requests)
        ...
        {!! $requests !!}
        <p><a href="{{ route('coaster.admin.home.requests') }}">View all requests</a></p>
        <br/>
    @endif
    ...
    @if ($any_user_requests)
        ...
        {!! $user_requests !!}
        <p><a href="{{ route('coaster.admin.home.your-requests') }}">View all your requests</a></p>
        <br/>
    @endif

    <h2>Site Updates:</h2>
    {!! $logs !!}
    <p><a href="{{ route('coaster.admin.home.logs') }}">View all admin logs</a></p>
  </div>
    <div class="col-md-4">
      ...
      @if($any_searches)
        <div class="well">
          ...
          <p><a href="{{ route('coaster.admin.search') }}">View all search logs</a></p>
        </div>
      @endif
    </div>
</div>
